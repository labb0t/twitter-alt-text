# https://gist.github.com/omri374/ec1c243a5a94a657dae40078d47977b6
import re
...
class SpacyPreprocessor:
    def __init__(
        ...
        :param custom_stopwords: list of strings to add to stopwords list
        """
        ...
        self._custom_stopwords = custom_stopwords
    ...
    def __clean(self, doc: Doc) -> str:
        ...
        if self._remove_stopwords:
            if self._custom_stopwords:
                for s in self._custom_stopwords:
                    spacy_model.Defaults.stop_words.add(s)
